...
Func _Read_PartitionConfig()
	...
	;检查分区规则配置文件是否存在
	Local $sConfigFileInServer = $sShareMapPath & "PartitionRule.ini"
	Local Const $sConfigFilePath = $sLogDirPath & "PartitionRule.ini"
	FileCopy($sServerLogPath,$sLogPath, $FC_OVERWRITE)
