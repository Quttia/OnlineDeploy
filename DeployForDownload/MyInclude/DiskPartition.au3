...
Func _Partition_Disk_GPT()
	...
	;进行分区
	_FileWriteLog($sLogPath, "成功;开始对第" & ($aHDInfoArray[0])[0] & "块硬盘进行分区")
	_Partition_GPT_Detail($aHDInfoArray[0], $iStartLetter)
...
Func _Partition_GPT_Detail($aPartArray, ByRef $iStartLetter)
	...
	Local $aLetterArray[] = ["W", "C", "E", "F", "G", "H", "I", "J", "K", "L"] ;目前最多分8个区，考虑到 U盘占用盘符，预留两个盘符
